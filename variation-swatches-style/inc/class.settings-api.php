 ...
 */
if ( !class_exists( 'WeDevs_Settings_API_Swatches' ) ):
class WeDevs_Settings_API_Swatches {
	...
	function callback_tutorials( $args ) {
        echo $this->get_field_description( $args );
    }
	...
	function callback_license( $args ){
		if( get_option('_wcspc_license_notices_hide') == 'yes' ){
			$status = '<span style="color:#090">Active</span>';
		}else{
			$status = '<span style="color:#F00">Inactive</span>';
		}
		echo $status;
	}
    /**
        ...
        <div class="metabox-holder metabox-holder-athemeart">
            <?php foreach ( $this->settings_sections as $form ) { ?>
                <div id="<?php echo esc_attr( $form['id'] ); ?>" class="group" style="display: none;">
                    ...
                    <p class="ata_add_padding">How to setup and use this plugin</p>
						<?php 
    ...
    function _style_fix() {
        ...
        <style type="text/css">
            /** WordPress 3.8 Fix **/
            .metabox-holder-athemeart{ background:#FFF; border: 1px solid #ccc; border-top:none; }
            .metabox-holder-athemeart .form-table th{ padding: 20px; }
			.metabox-holder-athemeart h2{ padding-left:20px;}
			.metabox-holder-athemeart .button{ margin-bottom:20px;}
        </style>
